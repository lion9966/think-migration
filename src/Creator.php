...
use think\App;
use think\migration\command\stubs\migrateStubs;
...
class Creator
{
    ...
    public function create(string $className)
    {
        ...
        // Load the alternative template if it is defined. +//$className
        $contents = file_get_contents($this->getTemplate($className));
    ...
    {
        (new migrateStubs($className))->table();
        return __DIR__ . '/command/stubs/migrateNew.stub';
    }
}
