...
use think\migration\command\stubs\seedStubs;
...
class Create extends Seed
{
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        // inject the class names appropriate to this seeder +//名字为表（首字母大写，不含前缀）模型名字
    ...
    {
        (new seedStubs($className))->seed();
        return __DIR__ . '/../stubs/seedNew.stub';
    }
}
